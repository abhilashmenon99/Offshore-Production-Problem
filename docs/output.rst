...
Formulating the problem as an ILP problem
...
:math:`Minim\_ capacity_{ij}\ :\ ` Minimum quantity that should be
produced by factory i in month j

:math:`Maxim\_ capacity_{ij}\ :` Maximum quantity that should be
produced by factory i in month j
...
..
   ...
   .. math:: x_{ij} \geq minim\_ capacity_{ij}*y_{ij}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \forall i\ \epsilon\ I\ \ and\ \ \forall\ \ j\epsilon J
...
..
   ...
   .. math:: x_{ij} \leq \ maxim\_ capacity_{ij}*y_{ij}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \forall i\ \epsilon\ I\ \ and\ \ \forall\ \ j\epsilon J
